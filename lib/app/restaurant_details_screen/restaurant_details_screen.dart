...
class RestaurantDetailsScreen extends StatelessWidget {
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          if (controller.vendorModel.value.workingHours!.isEmpty) {
                                            ShowToastDialog.showToast("Timing is not added by store");
                                          } else {
                                  ...
                                  TextFieldWidget(
                                    ...
                                    hintText: 'Search the dish, item, meals and more...'.tr,
                                    onchange: (value) {
  ...
  timeShowBottomSheet(BuildContext context, RestaurantDetailsController productModel) {
                                            ...
                                            children: List.generate(
                                              ...
                                              (i) {
                                                return InkWell(
                                                  onTap: () async {
                                                    if (controller.selectedIndexVariants.where((element) => element.contains('$index _')).isEmpty) {
                                                      ...
                                                      controller.selectedIndexVariants
                                                          .add('$index _${productModel.itemAttribute!.attributes![index].attributeOptions![i].toString()}');
                                                  ...
                                                  child: Chip(
                                                    shape: const RoundedRectangleBorder(
                                                        side: BorderSide(color: Colors.transparent), borderRadius: BorderRadius.all(Radius.circular(20))),
                                                    label: Row(
                                                      mainAxisSize: MainAxisSize.min,
                                                      children: [
                                                        Text(
                                        ...
                                        return Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                Constant.amountShow(amount: Constant.productCommissionPrice(price)),
                                                textAlign: TextAlign.start,
                                                maxLines: 1,
                                                style: TextStyle(
                                                  fontSize: 16,
                  ...
                  children: [
                            ...
                            InkWell(
                                onTap: () {
                                  if (productModel.itemAttribute == null) {
                                    ...
                                    int totalQuantity = int.parse(productModel.itemAttribute!.variants!
                    ...
                    Expanded(
                      ...
                      child: RoundedButtonFill(
                        title: "Add item ${Constant.amountShow(amount: controller.calculatePrice(productModel))}".tr,
                        height: 5.5,
                        color: AppThemeData.primary300,
                        textColor: AppThemeData.grey50,
                        fontSizes: 16,
                        onPress: () async {
                          if (productModel.itemAttribute == null) {
                            controller.addToCart(
                                productModel: productModel,
                                price: Constant.productCommissionPrice(productModel.price.toString()),
                                discountPrice: double.parse(productModel.disPrice.toString()) <= 0 ? "0" : Constant.productCommissionPrice(productModel.disPrice.toString()),
                                isIncrement: true,
                            ...
                            VariantInfo variantInfo = VariantInfo(
                                ...
                                variantImage:
                                    productModel.itemAttribute!.variants!.where((element) => element.variantSku == controller.selectedVariants.join('-')).first.variantImage ?? '',
                                variantId:
                                    productModel.itemAttribute!.variants!.where((element) => element.variantSku == controller.selectedVariants.join('-')).first.variantId ?? '0');
